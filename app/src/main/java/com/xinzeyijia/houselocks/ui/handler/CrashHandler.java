package com.xinzeyijia.houselocks.ui.handler;
...
public class CrashHandler implements UncaughtExceptionHandler, Thread.UncaughtExceptionHandler {
    ...
    public void saveCrashInfo2File(Throwable ex) {
        ...
        try {  
            ...
            SDCardUtils.saveException(time + sb.toString());
        } catch (Exception e) {  
