package com.xinze.xzhomestay.tmvp.view.myview
...
import com.xinzeyijia.houselocks.ui.view.OnViewPagerListener
 ...
 *  @time 2018/8/9  15:38
 */
class MyLayoutManager(context: Context) : LinearLayoutManager(context), RecyclerView.OnChildAttachStateChangeListener {
