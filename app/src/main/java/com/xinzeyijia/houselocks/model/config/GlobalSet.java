...
//    public static final String DETECT_VIS_MODEL = PATH
//            + "detect/detect_rgb-customized-pa-faceid_4_0.model.int8-3ff03fd4c564";
    ...
    public static final String LIVE_VIS_MODEL = PATH
            + "silent_live/liveness_rgb-customized-pa-anakin.model.float32-4.1.8.1";
    ...
    public static final String EyeClose_Model = PATH + "eye_close/eyes-customized-pa-mobile.model.float32-a1e35e8373eb";
    public static final String MouthClose_Model = PATH +
            "mouth_close/mouth-customized-pa-mobile.model.float32-9f29c56d96e8";
