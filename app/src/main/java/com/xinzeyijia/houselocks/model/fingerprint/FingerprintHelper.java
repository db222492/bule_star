...
public class FingerprintHelper extends FingerprintManager.AuthenticationCallback {
    ...
    /**
     * @description -2 支持指纹但是没有录入指纹； 1：有可用指纹； -1，手机不支持指纹
     * @author HaganWu
    ...
    public void onAuthenticationError(int errorCode, CharSequence errString) {
        loge("hagan", "onAuthenticationError-> errorCode:" + errorCode + ",errString:" + errString);
        if (callback != null) {
    ...
    public void onAuthenticationHelp(int helpCode, CharSequence helpString) {
        loge("hagan", "onAuthenticationHelp->helpCode:>" + helpCode + ",helpString:" + helpString.toString());
        if (callback != null) {
    ...
    public void onAuthenticationFailed() {
        loge("hagan", "onAuthenticationFailed->" + "onAuthenticationFailed");
        if (callback != null) {
            callback.onAuthenticationFail();
        }
    }
