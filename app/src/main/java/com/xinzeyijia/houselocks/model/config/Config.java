...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "HGBt0GFOVNpD5DGBMW2AV3S5";
    public static String secretKey = "aaQj3a8TgPQY766ARLNyW2hO5wvQTFCU";
    public static String licenseID = "houselocks-face-android";
